        ...
        <div>
            ...
            <form id="contact-form" action="" method="POST">
                        ...
                        <div style=" margin-right:680px">
                            ...
                            <input type="text" name="tital"  disabled value="<?php echo $data['tital']; ?> ">
                        ...
                        <br>
                        <textarea rows="13" disabled name="message" value=" " class="form-control" placeholder="    Write Message Here .............." required="" style=" padding : 15px; background-color: rgba(50, 115, 220, 0.3); height : 500px; width:1100px;"> <?php echo $data['content']; ?> </textarea>

                        <br><br>
                        <center>  <a href="viewdiary.php" class="my-2 btn btn-primary btn-sm bg-primary  text-white rounded " " ><i class="far fa-eye"></i> View Diary </a>
</center>
